...
const Values = () => {
  return (
    ...
    >
      <Image src="/values1.jpeg" alt="values" width={650} height={300} />
      <article className="sm:w-[25vw] sm:min-h-[30rem] text-xl bg-blue-200 m-3 p-6 pb-14 rounded-lg text-blue-900">
      ...
      <Image src="/values2.jpeg" alt="values" width={650} height={300} />
    </section>
  );
};
