...
const ButtonC = ({ name, path }: ButtonProp) => {
  return (
    <Link
      href={path}
      className="hover:bg-blue-900 text-blue-900 font-medium hover:text-blue-100 group relative ease-in-out duration-300 text-xl px-2 py-1 rounded-lg overflow-hidden cursor-pointer"
    >
      {name}
